package com.mycompany.jasperprojek;
...
public class JasperProjek {
    ...
    public static void main(String[] args) throws FileNotFoundException, JRException {
        ...
        String connectionUrl =
                "jdbc:sqlserver://localhost:1433;" +
                        "database=University; user=rijan; password=aminmssql1;" +
    ...
    private static JasperReport getJasperReport() throws FileNotFoundException, JRException {
        File template = Paths.get("C:\\Users\\ACER\\JaspersoftWorkspace\\MyReports\\Testjasper1.jrxml").toFile();
